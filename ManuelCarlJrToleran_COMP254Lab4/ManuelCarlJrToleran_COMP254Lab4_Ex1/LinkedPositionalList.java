...
public class LinkedPositionalList<E> implements PositionalList<E> {
   ...
   * @param p the Position of the element to get the index of
   * @return the index of the element in the Position provided. Returns -1 if not found.
   * @throws IllegalArgumentException if p is not a valid position for this list
   */
  public int indexOf(Position<E> p) throws IllegalArgumentException {
    ...
    int index = 0;
    while(walk.hasNext()){
      if(walk.next().equals(p.getElement())){
        return index;
      }
      index++;
    }
